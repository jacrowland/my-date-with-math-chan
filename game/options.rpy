...
define config.name = _("My Date With Math Chan")
...
define gui.about = _p("""UoA Math102 Creative Work S1 2019 by Jacob Rowland (jrow952)
...
This visual novel explores my relationship and emotions towards mathematics (or "What is maths (to you)") as personified by 'Math Chan', a fictional university student who the player attempts to ask out on a date.

{i}I'm fully aware of how weird this is but this was fun to make and I think it's pretty unique.{/i}
...
{b} Where did you get the images from? {/b}
...
define build.name = "datewithmathchan"
...
define config.main_menu_music = "tenderness.mp3"
...
define config.save_directory = "mydatewithmathchan-1555820206"
